...
RcppExport SEXP _BayesMFsurv_llikWeibull2(SEXP YSEXP, SEXP eXBSEXP, SEXP alphaSEXP, SEXP CSEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type Y(YSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BayesMFsurv_llikWeibull2", (DL_FUNC) &_BayesMFsurv_llikWeibull2, 5},
    {NULL, NULL, 0}
};
