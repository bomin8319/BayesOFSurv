...
text (x=3.425, y =40, "BFGS.MF.Wei",col="purple")
...
text (x=1.06, y =15.5, "BFGS.MF.Wei",col="purple")
...
text (x=-4, y =0.35, "BFGS.MF.Wei",col="purple")
par(new=FALSE)
...
text (x=3, y =.85, "BFGS.MF.Wei",col="purple")
...
text (x=5, y =.55, "BFGS.MF.Wei",col="purple")
...
text (x=0, y =6.25, "Bayes.MF.Wei",col="orange")
par(new=FALSE)
...
text (x=3.46, y =40, "BFGS.MF.Wei",col="purple")
...
par(new=TRUE)
plot(density(Results[,51],na.rm=TRUE), main =" ", xlab = "P",xlim=local.xlim, ylim=local.ylim,col="purple")
text (x=1.06, y =15.2, "BFGS.MF.Wei",col="purple")
text (x=1.06, y =14.8, "Bayes.MF.Wei",col="orange")
text (x=1.06, y =14.4, "Wei",col="forestgreen")
par(new=FALSE)
...
text (x=3.425, y =38, "BFGS.MF.Wei",col="purple")
...
text (x=1, y =.38, "Bayes.MF.Exp",col="pink")
text (x=1, y =.35, "Bayes.MF.Wei",col="orange")
text (x=-4.2, y =0.35, "BFGS.MF.Wei",col="purple")
par(new=FALSE)
...
text (x=1.33, y =6, "Wei",col="purple")
text (x=0.7, y =6.1, "Bayes.MF.Exp",col="pink")
text (x=0, y =7.8, "Bayes.MF.Wei",col="orange")
par(new=FALSE)
...
par(new=TRUE)
plot(density(Results[,51],na.rm=TRUE), main =" ", xlab = "P",xlim=local.xlim, ylim=local.ylim,col="purple")
text (x=1.09, y =16.2, "BFGS.MF.Wei",col="purple")
...
text (x=1.33, y =6, "Wei",col="purple")
text (x=0.7, y =6.1, "Bayes.MF.Exp",col="pink")
text (x=0, y =8.5, "Bayes.MF.Wei",col="orange")
par(new=FALSE)
