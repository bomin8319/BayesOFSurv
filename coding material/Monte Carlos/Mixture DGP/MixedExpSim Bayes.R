...
output.BayesZWeibull = list(betas = summary(mcmc(BayesZWeibull$beta))[[1]][,1], gammas = summary(mcmc(BayesZWeibull$gamma))[[1]][,1], lambda = summary(mcmc(BayesZWeibull$lambda))[[1]][1])
